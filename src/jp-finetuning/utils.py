...
def eval_MARC_ja(dataset,llm_chain):
    ...
    marc_ja_score_balanced = balanced_accuracy_score(y_trues, y_preds)
    return marc_ja_score,marc_ja_score_balanced
...
def eval_JNLI(dataset,llm_chain):
    ...
    jnli_score_balanced = balanced_accuracy_score(y_trues, y_preds)

    return jnli_score,jnli_score_balanced
